...
const code = fs.readFileSync(path.join(__dirname, 'nsbmp.wasm'))
...
exports.decode = function (input) {
  ...
  // Decode input data
  const error = instance.exports.decode_bmp(metadataPointer, metadataPointer + 4, metadataPointer + 8, inputPointer, input.byteLength)
